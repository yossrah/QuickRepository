...
import { PullSubCategory } from '../../redux/actions/categoryAction';
...
const PullSubCategorie = ({id}) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    dispatch(PullSubCategory(id, subCategory));
  };
  ...
  return (
    ...
    <Box
        ...
        <ButtonSubmit type="submit" style={btStyle} variant="contained" title=" Remove Sub-category"/>
      </Box>
      </Box>
      </Grid>
      </Grid>
...
export default PullSubCategorie;